<div class="ui top blue inverted menu">
    ...
    <div id="vENV4" class="item">Mond1: <img style="height:20px;width: 20px" title="{$environment.date.moon1}" src="/inc/images/moon_{$environment.date.moon1}.png">, Mond2: <img style="height:20px;width: 20px" title="{$environment.date.moon2}" src="/inc/images/moon_{$environment.date.moon2}.png"></div>
    <div id="vENV5" class="item">Holiday</div>    
