...
<html>
    <head>
        <title>{block name=pageTitle}Oh My DADI - Oh My Dungeons And Dragons Interface{/block}</title>
        <meta charset="UTF-8" />
        ...
        <script charset="utf-8" src="/inc/components/jquery/jquery.min.js" type="text/javascript"></script>
        ...
        <script charset="utf-8" src="/inc/tinymce/tinymce/tinymce.min.js" type="text/javascript"></script>
        <script charset="utf-8" src="/inc/tinymce/tinymce/jquery.tinymce.min.js" type="text/javascript"></script>
        <script charset="utf-8" src="/inc/datatables/datatables/media/js/jquery.dataTables.min.js" type="text/javascript"></script>
        <script charset="utf-8" src="/inc/datatables/datatables/media/js/dataTables.semanticui.min.js" type="text/javascript"></script>
        ...
        <link rel="stylesheet" href="/inc/datatables/datatables/media/css/jquery.dataTables.min.css" media="screen">
        <link rel="stylesheet" href="/inc/datatables/datatables/media/css/dataTables.semanticui.min.css" media="screen">
