...
<html>
    <head>
        ...
        <script charset="utf-8" src="/lib/jquery/dist/jquery.min.js" type="text/javascript"></script>
        <script charset="utf-8" src="/lib/jquery-address/src/jquery.address.js" type="text/javascript"></script>
        <script charset="utf-8" src="/lib/semantic-ui-offline/semantic.min.js" type="text/javascript"></script>
        <script charset="utf-8" src="/lib/tinymce/tinymce.min.js" type="text/javascript"></script>
        <script charset="utf-8" src="/lib/tinymce/jquery.tinymce.min.js" type="text/javascript"></script>
        <script charset="utf-8" src="/lib/datatables.net/js/jquery.dataTables.min.js" type="text/javascript"></script>
        <script charset="utf-8" src="/lib/datatables.net-se/js/dataTables.semanticui.min.js" type="text/javascript"></script>
