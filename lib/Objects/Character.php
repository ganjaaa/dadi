...
class Character implements \DND\Interfaces\Objects {
    ...
    public function fillFromPostAll($a = NULL) {
        ...
        $this->hp = (isset($a["hpMax"]) ? $a["hpMax"] : 0) . ';' . (isset($a["hpCurrent"]) ? $a["hpCurrent"] : 0) . ';' . (isset($a["hpTemporary"]) ? $a["hpTemporary"] : 0);
    ...
    public function getClass1id() {
        return $this->class1Id;
    }

    public function setClass1id($value) {
        $this->class1Id = $value;
        return $this;
    }

    public function getClass1level() {
        return $this->class1Level;
    }

    public function setClass1level($value) {
        $this->class1Level = $value;
        return $this;
    }

    public function getClass2id() {
        return $this->class2Id;
    }

    public function setClass2id($value) {
        $this->class2Id = $value;
        return $this;
    }

    public function getClass2level() {
        return $this->class2Level;
    }

    public function setClass2level($value) {
        $this->class2Level = $value;
        return $this;
    }

    public function getClass3id() {
        return $this->class3Id;
    }

    public function setClass3id($value) {
        $this->class3Id = $value;
        return $this;
    }

    public function getClass3level() {
        return $this->class3Level;
    }

    public function setClass3level($value) {
        $this->class3Level = $value;
        return $this;
    }

    public function getClass4id() {
        return $this->class4Id;
    }

    public function setClass4id($value) {
        $this->class4Id = $value;
        return $this;
    }

    public function getClass4level() {
        return $this->class4Level;
    }

    public function setClass4level($value) {
        $this->class4Level = $value;
        return $this;
    }
    ...
    public function fillFromPost($array=array()) {
        ...
        if(isset($array["accountId"])){$this->accountId = $array["accountId"];}
        if(isset($array["active"])){$this->active = $array["active"];}
        if(isset($array["environmentId"])){$this->environmentId = $array["environmentId"];}
        if(isset($array["charname"])){$this->charname = $array["charname"];}
        if(isset($array["backgroundId"])){$this->backgroundId = $array["backgroundId"];}
        if(isset($array["alignment"])){$this->alignment = $array["alignment"];}
        if(isset($array["raceId"])){$this->raceId = $array["raceId"];}
        if(isset($array["class1Id"])){$this->class1Id = $array["class1Id"];}
        if(isset($array["class1Level"])){$this->class1Level = $array["class1Level"];}
        if(isset($array["class2Id"])){$this->class2Id = $array["class2Id"];}
        if(isset($array["class2Level"])){$this->class2Level = $array["class2Level"];}
        if(isset($array["class3Id"])){$this->class3Id = $array["class3Id"];}
        if(isset($array["class3Level"])){$this->class3Level = $array["class3Level"];}
        if(isset($array["class4Id"])){$this->class4Id = $array["class4Id"];}
        if(isset($array["class4Level"])){$this->class4Level = $array["class4Level"];}
        if(isset($array["exp"])){$this->exp = $array["exp"];}
        if(isset($array["inspiration"])){$this->inspiration = $array["inspiration"];}
        if(isset($array["proficiency"])){$this->proficiency = $array["proficiency"];}
        if(isset($array["initiative"])){$this->initiative = $array["initiative"];}
        if(isset($array["money"])){$this->money = $array["money"];}
        if(isset($array["savingThrows"])){$this->savingThrows = $array["savingThrows"];}
        if(isset($array["skills"])){$this->skills = $array["skills"];}
        if(isset($array["bonusModifier"])){$this->bonusModifier = $array["bonusModifier"];}
        if(isset($array["hp"])){$this->hp = $array["hp"];}
        if(isset($array["ac"])){$this->ac = $array["ac"];}
        if(isset($array["death"])){$this->death = $array["death"];}
    ...
    public static function getSQLAdd() {
        return "INSERT INTO `" . self::tableName . "` (`id`, `accountId`, `active`, `environmentId`, `charname`, `backgroundId`, `alignment`, `raceId`, `class1Id`, `class1Level`, `class2Id`, `class2Level`, `class3Id`, `class3Level`, `class4Id`, `class4Level`, `exp`, `inspiration`, `proficiency`, `initiative`, `money`, `savingThrows`, `skills`, `bonusModifier`, `hp`, `ac`, `death`, `diary`, `lastChange`, `lastActivity`, `equipmentQuiver1`, `equipmentQuiver2`, `equipmentQuiver3`, `equipmentHelmet`, `equipmentCape`, `equipmentNecklace`, `equipmentWeapon1`, `equipmentWeapon2`, `equipmentWeapon3`, `equipmentOffWeapon`, `equipmentGloves`, `equipmentArmor`, `equipmentObject`, `equipmentBelt`, `equipmentBoots`, `equipmentRing1`, `equipmentRing2` )" . " VALUES " . " (NULL , :accountId, :active, :environmentId, :charname, :backgroundId, :alignment, :raceId, :class1Id, :class1Level, :class2Id, :class2Level, :class3Id, :class3Level, :class4Id, :class4Level, :exp, :inspiration, :proficiency, :initiative, :money, :savingThrows, :skills, :bonusModifier, :hp, :ac, :death, :diary, :lastChange, :lastActivity, :equipmentQuiver1, :equipmentQuiver2, :equipmentQuiver3, :equipmentHelmet, :equipmentCape, :equipmentNecklace, :equipmentWeapon1, :equipmentWeapon2, :equipmentWeapon3, :equipmentOffWeapon, :equipmentGloves, :equipmentArmor, :equipmentObject, :equipmentBelt, :equipmentBoots, :equipmentRing1, :equipmentRing2 );";
    }
    ...
    public function bindSQLAdd(\PDOStatement &$stmt) {
        ...
        $stmt->bindParam(":class1Id", $this->class1Id);
        $stmt->bindParam(":class1Level", $this->class1Level);
        $stmt->bindParam(":class2Id", $this->class2Id);
        $stmt->bindParam(":class2Level", $this->class2Level);
        $stmt->bindParam(":class3Id", $this->class3Id);
        $stmt->bindParam(":class3Level", $this->class3Level);
        $stmt->bindParam(":class4Id", $this->class4Id);
        $stmt->bindParam(":class4Level", $this->class4Level);
    ...
    public static function getSQLEdit() {
        return "UPDATE `" . self::tableName . "` SET `accountId` = :accountId, `active` = :active, `environmentId` = :environmentId, `charname` = :charname, `backgroundId` = :backgroundId, `alignment` = :alignment, `raceId` = :raceId, `class1Id` = :class1Id, `class1Level` = :class1Level, `class2Id` = :class2Id, `class2Level` = :class2Level, `class3Id` = :class3Id, `class3Level` = :class3Level, `class4Id` = :class4Id, `class4Level` = :class4Level, `exp` = :exp, `inspiration` = :inspiration, `proficiency` = :proficiency, `initiative` = :initiative, `money` = :money, `savingThrows` = :savingThrows, `skills` = :skills, `bonusModifier` = :bonusModifier, `hp` = :hp, `ac` = :ac, `death` = :death, `diary` = :diary, `lastChange` = :lastChange, `lastActivity` = :lastActivity, `equipmentQuiver1` = :equipmentQuiver1, `equipmentQuiver2` = :equipmentQuiver2, `equipmentQuiver3` = :equipmentQuiver3, `equipmentHelmet` = :equipmentHelmet, `equipmentCape` = :equipmentCape, `equipmentNecklace` = :equipmentNecklace, `equipmentWeapon1` = :equipmentWeapon1, `equipmentWeapon2` = :equipmentWeapon2, `equipmentWeapon3` = :equipmentWeapon3, `equipmentOffWeapon` = :equipmentOffWeapon, `equipmentGloves` = :equipmentGloves, `equipmentArmor` = :equipmentArmor, `equipmentObject` = :equipmentObject, `equipmentBelt` = :equipmentBelt, `equipmentBoots` = :equipmentBoots, `equipmentRing1` = :equipmentRing1, `equipmentRing2` = :equipmentRing2 " . " WHERE `id` = :id;"; 
    }
    ...
    public function getAjax() {
        ...
        "class1Level" => $this->class1Level, 
        "class2Id" => $this->class2Id, 
        "class2Level" => $this->class2Level, 
        "class3Id" => $this->class3Id, 
        "class3Level" => $this->class3Level, 
        "class4Id" => $this->class4Id, 
        "class4Level" => $this->class4Level, 
        "exp" => $this->exp, 
    ...
    public function setFromSqlRow(&$rec) {
        ...
        $this->class1Id =  $rec["class1Id"];
        $this->class1Level =  $rec["class1Level"];
        $this->class2Id =  $rec["class2Id"];
        $this->class2Level =  $rec["class2Level"];
        $this->class3Id =  $rec["class3Id"];
        $this->class3Level =  $rec["class3Level"];
        $this->class4Id =  $rec["class4Id"];
        $this->class4Level =  $rec["class4Level"];
        $this->exp =  $rec["exp"];
