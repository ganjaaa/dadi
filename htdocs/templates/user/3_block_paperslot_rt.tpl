...
<div class="ui segment tooltip paperslot" style="right:{$x|default:0}px; top: {$y|default:0}px;" data-position="left center" data-id="{$id|default:0}" data-known="{$knowledge|default:0}" data-variation= "inverted very wide">
