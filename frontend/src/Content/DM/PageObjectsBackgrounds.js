...
class BackgroundTraits extends React.Component {
    ...
    componentDidMount() {
        fetch(this.state.api + '/backgroundId/' + this.props.row.original.id, {method: "GET"})
...
class PageObjectsBackgrounds extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
...
export default PageObjectsBackgrounds;
