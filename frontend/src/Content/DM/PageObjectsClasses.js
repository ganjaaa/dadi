...
class PageObjectsClasses extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ajax: '/v2/datatable/classes',
            api: '/v2/classes',
            loading: false,
            pages: '-1',
            pageSize: 10,
    ...
    submitDialogHandler(e) {
        ...
        formData.append('hd', this.state.formData.hd);
        formData.append('spellAbility', this.state.formData.spellAbility);
    ...
    render() {
        const columns = [{
                ...
                Header: 'Spell Ability',
                accessor: 'spellAbility',
                filterable: true
                        //Cell: props => <span className='number'>{props.value}</span> // Custom cell components!
            }, {
                Header: 'Description',
                    ...
                    <Modal open={openDialog} closeOnEscape={true} closeOnDimmerClick={false} >
                        ...
                        <Modal.Content>
                            <Form>
                                ...
                                <Form.Group widths='equal'>
                                    <Form.Input fluid label='Hit Dice' placeholder='1D20' defaultValue={formData.hd} uid="hd" onChange={this.changeDialogHandler} />
                                    <Form.Input fluid label='Spell Ability' placeholder='' defaultValue={formData.spellAbility} uid="spellAbility" onChange={this.changeDialogHandler} />
                                </Form.Group>
                                <Form.Group widths='equal'>
...
export default PageObjectsClasses;
