...
# PageController
$app->get('/', '\DND\Controller\PageController:pageReact');
$app->get('/dashboard', '\DND\Controller\PageController:pageReact');
$app->get('/login', '\DND\Controller\PageController:pageReact');
